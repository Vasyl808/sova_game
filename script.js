...
let score = 0;
let highScore = localStorage.getItem('cryptoOwlHighScore') || 0;
...
class Cloud {
    ...
    draw() {
        ...
        ctx.arc(this.x + 30 * this.scale, this.y - 5 * this.scale, 35 * this.scale, 0, Math.PI * 2);
...
function drawOwl() {
    ...
    wingGradient1.addColorStop(0, '#8B4513');
    wingGradient1.addColorStop(1, '#A0522D');
    ...
    wingGradient2.addColorStop(0, '#8B4513');
    wingGradient2.addColorStop(1, '#A0522D');
...
function drawObstacles() {
    obstacles.forEach(obs => {
        const topGradient = ctx.createLinearGradient(obs.x, 0, obs.x + obstacleWidth, 0);
        ...
        ctx.fillStyle = topGradient;
        ctx.fillRect(obs.x, obs.top + gap, obstacleWidth, canvas.height - obs.top - gap);
        ctx.strokeRect(obs.x, obs.top + gap, obstacleWidth, canvas.height - obs.top - gap);
